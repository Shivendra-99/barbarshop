...
const EN = {
  ...
  'home.nearTitle': 'Skip the wait, near you',
  'home.nearSub': 'The closest salons to you right now. Pick a slot and walk straight in.',
  'home.nearPrompt': 'Share your location to see the closest salons and book a slot with no queue.',
  'home.nearCta': 'Show salons near me',
  'home.nearLocating': 'Finding you…',
  'home.nearRefresh': 'Update location',
  'home.nearNone': 'No partner salons within {km} km yet. Browse by city below.',
  'home.nearDenied': 'Location is off. Allow location access in your browser to see salons near you.',
  ...
  'book.couponRow': 'Coupon {code}',
  'book.couponPlaceholder': 'Have a coupon code?',
  'book.couponApply': 'Apply',
  'book.couponChecking': 'Checking…',
  'book.couponRemove': 'Remove',
  'book.couponApplied': 'Coupon {code} applied',
  'book.couponSave': 'You save {amount}',
  'book.couponNotBetter': 'Your current discount saves {amount} — more than this coupon, so we kept it.',
  'book.couponInvalid': 'This coupon is not valid.',
  'book.couponOnlineOnly': 'Coupons apply to online payments only.',
  'book.couponPickService': 'Choose a service first.',
  'book.couponOffers': 'Available offers',
  'book.couponOffPct': '{pct}% off',
  'book.couponOffFlat': '{amount} off',
  'book.couponUpTo': 'up to {amount}',
  'book.couponMin': 'min order {amount}',
  'book.couponAddMore': 'Add {amount} more to use this',
  'book.payNow': 'Pay now',
  ...
  'done.otpHint': 'Your service OTP is saved in My Bookings and sent to your phone. Share it with the salon only after your service — they need it to complete the booking.',
  'done.where': 'Where',
  ...
  'appt.billPaid': 'Amount paid',
  'appt.billFee': 'Cancellation fee ({pct}%)',
  'appt.billTotal': 'You get back',
  'appt.billTo': 'To {dest} · {eta}',
  ...
  'appt.cancelledBySalon': 'Cancelled by the salon — you were not charged.',
  'appt.nsRefundTitle': 'Choose your refund',
  'appt.nsRefundConfirm': 'Confirm refund',
  'appt.nsRefundConfirming': 'Processing…',
  ...
  'acc.cityHint': 'Pick a city above, enter any PIN code, or use your current location.',
  'acc.cityPinPlaceholder': 'Enter 6-digit PIN code',
  'acc.citySet': 'Set',
  'acc.cityDetect': 'Use my location',
  'acc.cityDetecting': 'Detecting…',
  'acc.cityUpdated': 'City set to {city}',
  'acc.cityPinErr': 'Could not find that PIN code.',
  'acc.cityDetectErr': 'Could not detect location',
  'acc.session': 'Session',
...
const HI = {
  ...
  'home.nearTitle': 'इंतज़ार छोड़ें, आपके पास',
  'home.nearSub': 'अभी आपके सबसे पास के सैलून। स्लॉट चुनें और बिना लाइन के सीधे जाएँ।',
  'home.nearPrompt': 'अपनी लोकेशन शेयर करें और बिना लाइन के सबसे पास के सैलून में स्लॉट बुक करें।',
  'home.nearCta': 'मेरे पास के सैलून दिखाएँ',
  'home.nearLocating': 'आपको खोज रहे हैं…',
  'home.nearRefresh': 'लोकेशन अपडेट करें',
  'home.nearNone': '{km} किमी के भीतर अभी कोई पार्टनर सैलून नहीं। नीचे शहर के अनुसार देखें।',
  'home.nearDenied': 'लोकेशन बंद है। पास के सैलून देखने के लिए ब्राउज़र में लोकेशन की अनुमति दें।',
  ...
  'book.couponRow': 'कूपन {code}',
  'book.couponPlaceholder': 'कूपन कोड है?',
  'book.couponApply': 'लगाएँ',
  'book.couponChecking': 'जाँच हो रही है…',
  'book.couponRemove': 'हटाएँ',
  'book.couponApplied': 'कूपन {code} लागू हुआ',
  'book.couponSave': 'आप {amount} बचा रहे हैं',
  'book.couponNotBetter': 'आपकी मौजूदा छूट {amount} बचाती है — इस कूपन से ज़्यादा, इसलिए वही रखी।',
  'book.couponInvalid': 'यह कूपन मान्य नहीं है।',
  'book.couponOnlineOnly': 'कूपन केवल ऑनलाइन भुगतान पर लागू होते हैं।',
  'book.couponPickService': 'पहले एक सेवा चुनें।',
  'book.couponOffers': 'उपलब्ध ऑफ़र',
  'book.couponOffPct': '{pct}% छूट',
  'book.couponOffFlat': '{amount} की छूट',
  'book.couponUpTo': 'अधिकतम {amount}',
  'book.couponMin': 'न्यूनतम ऑर्डर {amount}',
  'book.couponAddMore': 'इसके लिए {amount} और जोड़ें',
  ...
  'done.otpHint': 'आपका सर्विस OTP मेरी बुकिंग में सेव है और आपके फ़ोन पर भेजा गया है। इसे सैलून को केवल सेवा के बाद बताएं — बुकिंग पूरी करने के लिए उन्हें इसकी ज़रूरत है।',
  'done.where': 'कहाँ',
  'done.address': 'पता',
  ...
  'appt.billPaid': 'भुगतान की गई राशि',
  'appt.billFee': 'रद्दीकरण शुल्क ({pct}%)',
  'appt.billTotal': 'आपको वापस मिलेंगे',
  'appt.billTo': '{dest} में · {eta}',
  'appt.nsRefundPending': '15% नो-शो पेनल्टी लागू। अपना {amount} रिफंड कहाँ पाना है चुनें।',
  'appt.nsRefundChoose': 'रिफंड चुनें',
  'appt.cancelledBySalon': 'सैलून ने रद्द किया — आपसे कोई शुल्क नहीं लिया गया।',
  'appt.nsRefundTitle': 'अपना रिफंड चुनें',
  'appt.nsRefundConfirm': 'रिफंड पक्का करें',
  'appt.nsRefundConfirming': 'प्रोसेस हो रहा है…',
  ...
  'acc.cityHint': 'ऊपर से कोई शहर चुनें, कोई भी पिन कोड डालें, या अपनी मौजूदा लोकेशन इस्तेमाल करें।',
  'acc.cityPinPlaceholder': '6 अंकों का पिन कोड डालें',
  'acc.citySet': 'सेट करें',
  'acc.cityDetect': 'मेरी लोकेशन इस्तेमाल करें',
  'acc.cityDetecting': 'पता लगाया जा रहा है…',
  'acc.cityUpdated': 'शहर {city} सेट किया गया',
  'acc.cityPinErr': 'वह पिन कोड नहीं मिला।',
  'acc.cityDetectErr': 'लोकेशन का पता नहीं लगा सके',
  'acc.session': 'सत्र',
