...
const EN = {
  ...
  'book.couponNotBetter': 'Your current discount is already better, so this coupon was not applied.',
...
const HI = {
  ...
  'book.couponNotBetter': 'आपकी मौजूदा छूट पहले से बेहतर है, इसलिए यह कूपन लागू नहीं हुआ।',
